...
$race_name[1] ='Человек';
$race_str[1] = 10;  // Сила
$race_dex[1] = 10;  // Ловкость
$race_int[1] = 10;  // Интеллект
$race_wis[1] = 10;  // Мудрость
$race_con[1] = 10;  // Телосложение
$race_hp[1] = 1;
$race_mana[1] = 1;
$race_exp[1] = -0.05;
$race_bal[1] = 15;
...
$race_name[3] ='Гном';
$race_str[3] = 10;  // Сила
$race_dex[3] = 8;   // Ловкость
$race_int[3] = 10;  // Интеллект
$race_wis[3] = 11;  // Мудрость
$race_con[3] = 11;  // Телосложение
$race_hp[3] = 2;
$race_mana[3] = 1;
$race_exp[3] = 0.05;
$race_bonus[3][2] = 10;
