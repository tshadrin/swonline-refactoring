...
$game_skill_do_SQL[18][7]= "INSERT INTO sw_users (name,up_name,npc,madeby,pwr,typ,typ_num,typ2,typ2_num,room,online,level,chp,chp_percent,bad,live,sex) values ('@Элементаль@','@Элементаль@',1,$player_id,1,18,1,18,4,$pl_room[$player_id],$currentTimestamp,$level,80+10*$level,100,1,$live,1)";
