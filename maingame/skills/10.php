...
$game_skill_afflict[10][2] = ",aff_see_all={$currentTimestamp}+20*12";
...
$game_skill_afflict[10][3] = ",aff_tree={$currentTimestamp}+5*12";
...
$live = $currentTimestamp + 120;
$level = round( $pl_level[$player_id] );
$game_skill_do_SQL[10][5] = "INSERT INTO sw_users (name,up_name,npc,madeby,pwr,typ,typ_num,typ2,typ2_num,room,online,level,chp,chp_percent,bad,live,sex,heal) values ('@Зверь@','@Зверь@',1,{$player_id},35,100,1,104,1,{$pl_room[$player_id]},{$currentTimestamp},{$level},90+10*{$level},100,1,{$live},1,0)";
