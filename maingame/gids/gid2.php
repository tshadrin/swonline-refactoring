...
if ( 0 < $player_room )
{
    ...
    if ( $owner_id == $player_id && $owner_typ == 0 )
    {
        ...
        $t = "";
        $t .= "<table><tr><td><table><tr><td width=75 align=center><img src=pic/stuff/else/gid.gif></td><td><b>Название создаваемой комнаты:</b> `Усыпальница`<br><br>Выберите направление строительства комнаты относительно вашего текущего местоположения.</td></tr></table>";
