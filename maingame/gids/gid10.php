...
if ( 0 < $player_room )
{
    ...
    if ( $owner_id == $player_clan && $owner_typ == 1 )
    {
        ...
        $text = "Ателье клана";
        $t = "";
        $t .= "<table><tr><td><table><tr><td width=75 align=center><img src=pic/stuff/else/gid.gif></td><td><b>Название создаваемой комнаты:</b> `Ателье`<br><br>Выберите направление строительства ателье относительно вашей текущей комнаты.</td></tr></table>";
