...
if ( 0 < $player_room )
{
    ...
    if ( $player_clan != 0 )
    {
        if ( $build == 2 )
        {
            ...
            $t = "";
            $t .= "<table><tr><td><table><tr><td width=75 align=center><img src=pic/stuff/else/gid.gif></td><td><b>Название создаваемого магазина:</b> `Магазин [{$litle}]`<br><br>Выберите направление строительства магазина относительно вашей текущей комнаты.</td></tr></table>";
