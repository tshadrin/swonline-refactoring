...
if ( 0 < $player_room )
{
    ...
    if ( $owner_id == $player_clan && $owner_typ == 1 )
    {
        ...
        $text = "Конюшня клана";
        $t = "";
        $t .= "<table><tr><td><table><tr><td width=75 align=center><img src=pic/stuff/else/gid.gif></td><td><b>Название создаваемой комнаты:</b> `конюшня`<br><br>Выберите направление строительства конюшни относительно вашей текущей комнаты.</td></tr></table>";
