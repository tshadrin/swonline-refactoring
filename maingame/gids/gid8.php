...
if ( 0 < $player_room )
{
    ...
    if ( $owner_id == $player_clan && $owner_typ == 1 )
    {
        ...
        $t = "";
        $t .= "<table><tr><td><table><tr><td width=75 align=center><img src=pic/stuff/else/gid.gif></td><td><b>Название создаваемой камнаты:</b> `Ювелирная мастерская`<br><br>Выберите направление строительства ювелирной относительно вашей текущей комнаты.</td></tr></table>";
